  ...
  {LEFTMENU}
    ...
    <!-- start: content -->
     <div class="content">
      ...
      <h4>Список членов команды</h4>
      
    <table class="info">
      <tr class="first_line">
        <td class="comment_menu_list"><h6>ID</h6></td>
        <td class="comment_menu_list"><h6>Фотография</h6></td>
        <td class="comment_menu_list"><h6>Имя</h6></td>
        <td class="comment_menu_list"><h6>Должность</h6></td>
        <td class="comment_menu_list"><h6>Почта</h6></td>
      ...
      <tr>
        ...
        <td class="menu_img_item"><img src="img/vadim_mamontov.png" alt="" height="150px" width="150px"></td>
        <td class="menu_name_item"><p>Вадим Мамонтов</p></td>
        <td class="menu_title_item"><p>Основатель и генеральный директор</p></td>
        <td class="menu_mail_item"><p>vadim.mamontov@gmail.com</p></td>
