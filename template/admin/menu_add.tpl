            ...
            <ul class="nav navbar-nav navbar-right user-nav">
                ...
                <li class="dropdown avatar-dropdown">
                    ...
                    <ul class="dropdown-menu user-dropdown">
                        <li><a href="login.php"><span class="fa fa-user"></span>Выход</a></li>
...
{LEFTMENU}
    ...
    <div class="content">
        ...
        <div class="menu_block">
            <form action="menu_add.php" method="POST" class="line_container">
                <div class="menu_id_input_item">
                    <label>
                        <h4>ID</h4>
                        <input type="text" name="menu_id" readonly value="4">
                    </label>
                </div>
                ...
                <div class="menu_button_container">
                    <button type="submit" class="button_color" name="sub">Сохранить</button>
                </div>
            </form>
        </div>
